...
const MIGRATIONS = [
  ...
  `ALTER TABLE "Task" ADD COLUMN IF NOT EXISTS "companyId" TEXT REFERENCES "Company"("id") ON DELETE SET NULL`,
  ...
  `ALTER TABLE "ActiveTimer" ADD COLUMN IF NOT EXISTS "category" TEXT`,
];
